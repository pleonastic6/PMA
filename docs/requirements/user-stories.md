...
## Match und Interaktion
- Als Nutzer will ich bei gegenseitigem Interesse ein Match erhalten, damit beide Seiten weiter interagieren können.
- Als Match will ich chatten können, damit aus einem Match eine echte Unterhaltung wird.

## Events und Karte
- Als Nutzer will ich Events erstellen, bearbeiten und filtern können, damit Treffen organisiert werden können.
- Als Nutzer will ich Event-Positionen auf einer Karte sehen können, damit ich Orte leichter einordnen kann.

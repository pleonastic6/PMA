...
## Gezeigtes Inkrement
- Matchliste
- Chat zwischen gematchten Personen
- Eventseiten im Frontend
- Erste Kartenintegration als Produktbestandteil

## Bezug zum horizontalen Produktbild
- Nach Personen und Interessen wurde jetzt die soziale Interaktion horizontal erweitert.

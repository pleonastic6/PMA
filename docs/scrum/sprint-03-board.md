...
| --- | --- | --- |
| To Do | - | - |
| In Progress | PMA-36 Kartenansicht fachlich vorbereiten | Fatima, Jonas |
| In Review | PMA-35 Eventseiten im UI | Amelie, Arturo |
| Done | PMA-31 Registrierungsfluss, PMA-32 Swipe-Flow, PMA-33 Chat, PMA-34 Matchliste | Nina, Mehmet, Sophie, Luca |
| Blocked | - | - |

## Sprintdynamik
- Ein Teil des Teams arbeitete sichtbar am Produktwert.
- Ein anderer Teil baute technische Grundlage fuer die spaetere echte Event- und Kartenanbindung.
- Dadurch war das Board nicht nur gruen, sondern realistisch gemischt.

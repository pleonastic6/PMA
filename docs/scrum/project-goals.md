...
## Status
- Diese Datei fasst User-Story-Perspektive und SMART-Ziele fuer PMA kompakt zusammen.

## Zentrale User Stories
- Als neuer Nutzer will ich mich registrieren und einloggen koennen, damit ich einen persistenten Einstieg in die App habe.
- Als Nutzer will ich mein Profil mit Interessen, Sprachen und persoenlichen Infos pflegen koennen, damit andere mich sinnvoll entdecken koennen.
- Als Nutzer will ich Menschen swipen koennen, damit ich passende Kontakte finde.
- Als Nutzer will ich nicht nur Menschen, sondern auch Hobbys, Events und Locations swipen koennen, damit Discovery nicht wie ein reiner Dating-Flow wirkt.
- Als Match will ich chatten koennen, damit aus einem Match echte Interaktion wird.
...
- Kein Ziel des MVP ist vollstaendige Feature-Tiefe in allen Discovery-Kontexten.

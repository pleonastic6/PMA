...
## Sprint Goal
- Der bisherige Frontend-Prototyp soll in einen ersten echten vertikalen Produktfluss überführt werden: Nutzerprofile mit Interessen/Hobbys, echte Authentifizierung und ein Discovery-Kern, der später auch Events und Locations tragen kann.
...
| PMA-17 | Als Team wollen wir Interessen als Discovery-Basis modellieren | Profilfelder für Hobbys/Interessen sind fachlich nutzbar | 3 SP |
